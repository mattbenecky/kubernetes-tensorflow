...
# Create Azure AD Group AKS Cluster Admin to add security principals that need AKS permissions
az ad group create --display-name "AKS Cluster Admin" --mail-nickname "Admin"
# Create Azure AD Group Grafana Viewer to add security principals that need Grafana permissions
